...
@testset "Problem 2.2" begin
    K_expected = [170 -170 0 0; -170 510 -340 0; 0 -340 510 -170; 0 0 -170 170]
    @test K ≈ K_expected rtol=1e-10
    k_expected = [510 -340 0; -340 510 -170; 0 -170 170]
    @test k ≈ k_expected rtol=1e-10
    @test f ≈ [0.0; 0.0; 25.0] rtol=1e-10
    u_expected = [0.14705882352941177; 0.22058823529411764; 0.36764705882352944]
    @test u ≈ u_expected rtol=1e-10
    U_expected = [0.0; 0.14705882352941177; 0.22058823529411764; 0.36764705882352944]
    @test U ≈ U_expected rtol=1e-10
    @test F ≈ [-25.0; 0.0; 0.0; 25.0] rtol=1e-10
end
