...
@testset "Problem 2.1" begin
    @test K ≈ [200 -200 0; -200 450 -250; 0 -250 250] rtol=1e-10
    @test k ≈ [450.0] rtol=1e-10
    @test f ≈ [10.0] rtol=1e-10
    @test u ≈ [0.022222222222222223] rtol=1e-10
    @test U ≈ [0.0; 0.022222222222222223; 0.0] rtol=1e-10
    @test F ≈ [-4.444444444444445; 10.0; -5.555555555555555] rtol=1e-10
    @test f1 ≈ [-4.444444444444445; 4.444444444444445] rtol=1e-10
    @test f2 ≈ [5.555555555555555; -5.555555555555555] rtol=1e-10
end
